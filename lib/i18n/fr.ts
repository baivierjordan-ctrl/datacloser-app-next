...
export const fr = {
  ...
  "campagne.demoActiver": "Inclure un lien de démonstration personnalisé",
  "campagne.demoDetail": "Chaque destinataire recevra un lien vers trois de ses propres prospects, déjà trouvés par le moteur. Rien à préparer de votre côté.",
  "campagne.demoAttente": "La campagne restera en pause le temps de préparer les liens (environ 30 minutes pour 100 destinataires). Vous pourrez l'activer ensuite.",
  "campagne.demoBloc": "J'ai lancé mon moteur sur votre marché : voici trois entreprises qui correspondent à vos clients types → {{lien_demo}}",
  "campagne.aideDemoTitre": "À quoi sert ce lien ?",
  "campagne.aideDemoTexte": "Avant l'envoi, le moteur lit le site de chaque destinataire, en déduit qui sont ses clients et cherche de vraies entreprises correspondantes. Le lien ouvre une page qui les affiche instantanément. Un destinataire sans site exploitable recevra le même email, sans cette phrase.",
  "demos.enCours": "Préparation des liens de démonstration",
  "demos.termine": "Liens de démonstration prêts",
  "demos.echec": "La préparation s'est interrompue",
  "demos.prets": "prêts",
  "demos.illisibles": "site(s) illisible(s)",
  "demos.patience": "Vous pouvez fermer cette page : la préparation continue côté serveur.",
  "demos.activerMaintenant": "Vous pouvez activer la campagne.",
  "demos.reprendre": "Reprendre la préparation",
