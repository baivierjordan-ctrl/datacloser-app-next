...
export const en: Traductions = {
  ...
  "campagne.demoActiver": "Include a personalised demonstration link",
  "campagne.demoDetail": "Each recipient gets a link to three of their own prospects, already found by the engine. Nothing to prepare on your side.",
  "campagne.demoAttente": "The campaign stays paused while the links are prepared (about 30 minutes for 100 recipients). You can activate it afterwards.",
  "campagne.demoBloc": "I ran my engine on your market: here are three companies matching your typical clients → {{lien_demo}}",
  "campagne.aideDemoTitre": "What is this link for?",
  "campagne.aideDemoTexte": "Before sending, the engine reads each recipient's website, works out who their clients are and searches for real matching companies. The link opens a page showing them instantly. A recipient without a usable website receives the same email, without that sentence.",
  "demos.enCours": "Preparing demonstration links",
  "demos.termine": "Demonstration links ready",
  "demos.echec": "Preparation was interrupted",
  "demos.prets": "ready",
  "demos.illisibles": "unreadable website(s)",
  "demos.patience": "You can close this page: preparation continues on the server.",
  "demos.activerMaintenant": "You can activate the campaign.",
  "demos.reprendre": "Resume preparation",
