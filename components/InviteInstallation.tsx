...
export function InviteInstallation() {
  ...
  return (
    <div
      ...
      className="flottant apparition fixed bottom-4 left-4 z-40 w-[min(28rem,calc(100vw-2rem))] rounded-xl border border-line bg-surface p-4 shadow-lg shadow-slate-900/10"
    >
