      ...
      <div className="mx-auto max-w-5xl">
        ...
        <header className="mb-8">
          <p className="mb-2 flex items-center gap-2 font-mono text-[12px] uppercase tracking-[0.2em] text-teal">
            <Crown size={13} aria-hidden="true" /> {t("admin.eyebrow")}
          </p>
        ...
        {!etat ? (
          ...
          <div className="flex flex-col gap-5">
            <section className="grid gap-4 sm:grid-cols-3">
              {[
                { valeur: etat.leads_caches, libelle: t("admin.leadsCache") },
                { valeur: etat.comptes.length, libelle: t("admin.comptes") },
                {
                  valeur: etat.agents_actifs.length,
                  libelle: t("admin.agentsActifs"),
                },
              ].map((carte) => (
                <div
                  key={carte.libelle}
              ...
              <div className="grid gap-4 sm:grid-cols-[1fr_auto_auto] sm:items-end">
                <div>
                  ...
                  <input
                    ...
                    placeholder={t("admin.compteExemple")}
                  />
                  <datalist id="comptes">
                    {etat.comptes.map((c) => (
            ...
            <section className="rounded-xl border border-line bg-surface p-5">
              ...
              <div className="flex flex-wrap items-end gap-3">
                ...
                {([true, false] as const).map((actif) => (
                  <button
                    ...
                    onClick={() =>
                      agir("agent", async () => {
                        ...
                        return `${t("admin.agentAvant")} ${r.actif ? t("admin.agentActive") : t("admin.agentDesactive")} ${t("admin.agentPour")} ${r.email}.`;
                      })
                    }
                  ...
                  >
                    {actif ? t("admin.activer") : t("admin.desactiver")}
                  </button>
                ))}
              </div>
            </section>
